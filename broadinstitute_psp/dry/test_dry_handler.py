...
class TestDryHandler(unittest.TestCase):
    ...
    def test_call_dry_happy_path(self, download_gct):
        ...
        self.assertEqual("/this/dir/psp_production.cfg", dry_call["psp_config_path"])
    ...
    def test_create_level_3_key(self):
        args = TestDryHandler.setup_args()
        level_3_key = dh.create_level_3_key(args)
        self.assertEqual("psp/level3/" + args.plate_name +"_LVL3" + dh.FILE_EXTENSION, level_3_key)
